...
learning_rate = tf.train.exponential_decay(learning_rate,
                                           ...
                                           decay_steps=20000, decay_rate=0.9)
...
# load module
net = BoxInceptionResnet(images, 4, name="boxnet", hardMining=False)
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True, intra_op_parallelism_threads=8)) as sess:
    writer = tf.summary.FileWriter("../logs_old/", sess.graph)
    ...
    while True:
        ...
        if i % 2000 == 0:
            ...
            saver.save(sess, "../model/model_Hard/model_" + str(i), write_meta_graph=False)
